...
export type ProposalVetoedEvent = TypedEvent<[BigNumber], ProposalVetoedEventObject>
...
export type QuorumVotesBPSSetEventFilter = TypedEventFilter<QuorumVotesBPSSetEvent>
