...
export type DescriptorLockedEventFilter = TypedEventFilter<DescriptorLockedEvent>

export interface DescriptorUpdatedEventObject {
  descriptor: string
}
export type DescriptorUpdatedEvent = TypedEvent<[string], DescriptorUpdatedEventObject>

export type DescriptorUpdatedEventFilter = TypedEventFilter<DescriptorUpdatedEvent>
...
export type NoundersDAOUpdatedEvent = TypedEvent<[string], NoundersDAOUpdatedEventObject>

export type NoundersDAOUpdatedEventFilter = TypedEventFilter<NoundersDAOUpdatedEvent>
...
export interface NounsToken extends BaseContract {
  ...
  callStatic: {
    ...
    burn(nounId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    ...
    NounBurned(tokenId?: PromiseOrValue<BigNumberish> | null): NounBurnedEventFilter
