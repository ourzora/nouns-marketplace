...
export interface INounsDescriptorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, PromiseOrValue<string>, INounsSeeder.SeedStruct]
  ): string
  encodeFunctionData(
...
export type DataURIToggledEvent = TypedEvent<[boolean], DataURIToggledEventObject>
...
export interface INounsDescriptor extends BaseContract {
  ...
  bodies(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>
  ...
  glasses(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>

  glassesCount(overrides?: CallOverrides): Promise<BigNumber>

  headCount(overrides?: CallOverrides): Promise<BigNumber>

  heads(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>
  ...
  callStatic: {
    ...
    addBody(body: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>
    ...
    addHead(head: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    baseURI(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
