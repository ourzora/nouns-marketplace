...
export interface E2ETestInterface extends utils.Interface {
  functions: {
    ...
    'test_FirstAuction()': FunctionFragment
    'test_InitialOwnership()': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'test_FirstAuction', values?: undefined): string
  encodeFunctionData(
    functionFragment: 'test_InitialOwnership',
    values?: undefined
  ): string
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'test_FirstAuction', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'test_InitialOwnership', data: BytesLike): Result
  decodeFunctionResult(
    functionFragment: 'test_ProposalVoteQueueExecution',
    data: BytesLike
  ): Result
...
export interface E2ETest extends BaseContract {
  ...
  callStatic: {
    ...
    test_FirstAuction(overrides?: CallOverrides): Promise<void>

    test_InitialOwnership(overrides?: CallOverrides): Promise<void>
