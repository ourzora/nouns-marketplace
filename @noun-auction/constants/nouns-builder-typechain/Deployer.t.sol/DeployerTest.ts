...
export interface DeployerTestInterface extends utils.Interface {
  functions: {
  ...
  decodeFunctionResult(functionFragment: 'test_TokenInitialized', data: BytesLike): Result
  decodeFunctionResult(
    functionFragment: 'test_TreasuryInitialized',
    data: BytesLike
  ): Result
...
export interface DeployerTest extends BaseContract {
