...
function FieldAnnotation(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(Flex, __spreadProps(__spreadValues({ className: ["zord-fieldannotation", annotation, className] }, props), { children: /* @__PURE__ */ (0, import_jsx_runtime45.jsx)(
    Text,
    {
...
function Modal(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime57.jsxs)(Dialog.Root, __spreadProps(__spreadValues({}, props), { children: [
    ...
    trigger && /* @__PURE__ */ (0, import_jsx_runtime57.jsx)(ModalTrigger, { asChild: true, children: trigger })
  ] }));
}
var ModalContent = import_react12.default.forwardRef(
  (_a, ref) => {
    var _b = _a, {
      className,
      children,
